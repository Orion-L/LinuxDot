...
hi ColorColumn guifg=#d7d7af guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
...
hi Cursor guifg=#080808 guibg=NONE guisp=#afd75f gui=NONE ctermfg=232 ctermbg=NONE cterm=NONE
hi CursorColumn guifg=#d7d7af guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi CursorLine guifg=#d7d7af guibg=NONE guisp=NONE gui=NONE ctermfg=187 ctermbg=NONE cterm=NONE
hi CursorLineNr guifg=#bcbcbc guibg=NONE guisp=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE
...
hi DiffAdd guifg=#e4e4e4 guibg=NONE guisp=#5faf5f gui=NONE ctermfg=254 ctermbg=NONE cterm=NONE
hi DiffChange guifg=#262626 guibg=NONE guisp=#d7d787 gui=NONE ctermfg=238 ctermbg=NONE cterm=NONE
hi DiffDelete guifg=#e4e4e4 guibg=NONE guisp=#ff8787 gui=NONE ctermfg=254 ctermbg=NONE cterm=NONE
hi DiffText guifg=#121212 guibg=NONE guisp=#d7d787 gui=bold ctermfg=233 ctermbg=NONE cterm=bold
hi Directory guifg=#87af87 guibg=NONE guisp=NONE gui=NONE ctermfg=108 ctermbg=NONE cterm=NONE
hi EndOfBuffer guifg=#444444 guibg=NONE guisp=NONE gui=NONE ctermfg=238 ctermbg=NONE cterm=NONE
hi Error guifg=#ffafaf guibg=NONE guisp=NONE gui=NONE ctermfg=217 ctermbg=NONE cterm=NONE
...
hi Folded guifg=#87afaf guibg=NONE guisp=#080808 gui=NONE ctermfg=109 ctermbg=NONE cterm=NONE
...
hi IncSearch guifg=#1c1c1c guibg=NONE guisp=#ffffaf gui=NONE ctermfg=234 ctermbg=NONE cterm=NONE
...
hi MatchParen guifg=#afd787 guibg=NONE guisp=#1c1c1c gui=bold ctermfg=150 ctermbg=NONE cterm=bold
...
hi Pmenu guifg=#afaf5f guibg=NONE guisp=NONE gui=NONE ctermfg=143 ctermbg=NONE cterm=NONE
hi PmenuSbar guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi PmenuSel guifg=#ffffd7 guibg=NONE guisp=NONE gui=NONE ctermfg=230 ctermbg=NONE cterm=NONE
...
hi Search guifg=#444444 guibg=NONE guisp=#ffffd7 gui=NONE ctermfg=238 ctermbg=NONE cterm=NONE
hi SignColumn guifg=#87afaf guibg=NONE guisp=NONE gui=NONE ctermfg=109 ctermbg=NONE cterm=NONE
...
hi SpellBad guifg=NONE guibg=NONE guisp=#d70000 gui=undercurl ctermfg=160 ctermbg=NONE cterm=underline
hi SpellCap guifg=NONE guibg=NONE guisp=#005fff gui=undercurl ctermfg=20 ctermbg=NONE cterm=underline
hi SpellLocal guifg=NONE guibg=NONE guisp=#ffafaf gui=undercurl ctermfg=166 ctermbg=NONE cterm=underline
hi SpellRare guifg=NONE guibg=NONE guisp=#606060 gui=undercurl ctermfg=245 ctermbg=NONE cterm=underline
hi Statement guifg=#87afd7 guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
hi StatusLine guifg=#bcbcbc guibg=NONE guisp=NONE gui=NONE ctermfg=250 ctermbg=NONE cterm=NONE
hi StatusLineNC guifg=#9e9e9e guibg=NONE guisp=NONE gui=NONE ctermfg=247 ctermbg=NONE cterm=NONE
...
hi TabLine guifg=#303030 guibg=NONE guisp=NONE gui=NONE ctermfg=236 ctermbg=NONE cterm=NONE
hi TabLineFill guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi TabLineSel guifg=#e4e4e4 guibg=NONE guisp=NONE gui=bold ctermfg=254 ctermbg=NONE cterm=bold
...
hi Todo guifg=#080808 guibg=NONE guisp=NONE gui=NONE ctermfg=232 ctermbg=NONE cterm=NONE
...
hi VertSplit guifg=#262626 guibg=NONE guisp=NONE gui=NONE ctermfg=235 ctermbg=NONE cterm=NONE
hi Visual guifg=#080808 guibg=NONE guisp=#ffffaf gui=NONE ctermfg=232 ctermbg=NONE cterm=NONE
hi VisualNOS guifg=#080808 guibg=NONE guisp=#d7d7af gui=NONE ctermfg=232 ctermbg=NONE cterm=NONE
hi WarningMsg guifg=#ff8787 guibg=NONE guisp=NONE gui=NONE ctermfg=210 ctermbg=NONE cterm=NONE
hi WildMenu guifg=#d7d75f guibg=NONE guisp=NONE gui=NONE ctermfg=185 ctermbg=NONE cterm=NONE
